"""Publication-quality HTML report generation for BenchForge benchmark results.
...
<title>BenchForge Report — {{ result.scenario.name }}</title>
...
<section class="section">
  ...
  <div class="env-grid">
    ...
    <div class="env-item"><span class="env-label">BenchForge:</span>v{{ result.benchflow.version }}</div>
  </div>
...
<!-- ===== Footer ===== -->
<footer class="footer">
  Generated by BenchForge v{{ result.benchflow.version }} &middot; {{ result.created_at[:19] }} UTC
</footer>
